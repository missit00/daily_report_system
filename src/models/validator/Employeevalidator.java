...
public class Employeevalidator {
	public static List<String> validate(Employee e, Boolean code_dupulicate_check_flag, Boolean password_check_flag) {
		...
		String code_error = _validateCode(e.getCode(), code_dupulicate_check_flag);
	...
	private static String _validateCode(String code, Boolean code_depulicate_check_flag) {
		if (code == null || code.equals("")) {
			return "社員番号を入力してください。";

		}

		if (code_depulicate_check_flag) {
